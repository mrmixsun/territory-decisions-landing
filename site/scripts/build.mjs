...
function landingPageS11() {
  ...
  const body = `<section class="s11-hero" id="hero"><div class="container s11-hero__grid"><div class="s11-hero__copy"><span class="s11-kicker">${e(hero.eyebrow)}</span><h1>${heroTitle}</h1><p>${heroLead}</p></div><figure class="s11-hero__visual"><img src="${asset('territory-isometric.svg')}" alt="${e(hero.visualCaption)}"><figcaption>Территория · данные · решение</figcaption></figure></div></section>
